...
(function() {
  ...
  this["(v4) store SPO, POS both as keys only"] = function(T, done) {
    ...
    value_matchers = [[0x54, 0x70, 0x6f, 0x73, 0x00, 0x54, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x00, 0x54, 0xe4, 0xbb, 0x9f, 0x00, 0x45, 0x54, 0xe5, 0x8d, 0x83, 0x00, 0x00, 0x4c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], [0x54, 0x70, 0x6f, 0x73, 0x00, 0x54, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x00, 0x54, 0xe9, 0x9f, 0x86, 0x00, 0x45, 0x54, 0xe5, 0x8d, 0x83, 0x00, 0x00, 0x4c, 0x3f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], [0x54, 0x73, 0x70, 0x6f, 0x00, 0x45, 0x54, 0xe5, 0x8d, 0x83, 0x00, 0x00, 0x54, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x00, 0x45, 0x54, 0xe4, 0xbb, 0x9f, 0x00, 0x54, 0xe9, 0x9f, 0x86, 0x00, 0x00]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: [],
      ...
      return input.pipe((function(_this) {
        return function() {
          ...
          return D.$observe(function(record) {
            var key, value;
            idx += +1;
  ...
  this["(v4) read POS phrases (sbj is a list)"] = function(T, done) {
    ...
    matchers = [['pos', 'usagecode', 'CJKTHM', ['glyph', '千']], ['pos', 'variant', '仟', ['glyph', '千'], 0], ['pos', 'variant', '韆', ['glyph', '千'], 1]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: ['pos'],
  ...
  this["(v4) read POS phrases (sbj isn't a list)"] = function(T, done) {
    ...
    matchers = [['pos', 'usagecode', 'CJKTHM', '千'], ['pos', 'variant', '仟', '千', 0], ['pos', 'variant', '韆', '千', 1]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: ['pos'],
  ...
  this["eeeeeeeeeeeeeeeeee"] = function(T, done) {
    ...
    write_data = function(handler) {
      ...
      input.write(['A1', 'reading', 'A1', ['a1', 'ā']]);
      input.write(['A2', 'reading', 'A2', ['a2', 'á']]);
      input.write(['E3', 'reading', 'E3', ['e3', 'ǎ']]);
      input.write(['A4', 'reading', 'A4', ['a4', 'à']]);
      input.write(['A5', 'reading', 'A5', ['a5', 'a']]);
      input.write(['E1', 'reading', 'E1', ['e1', 'ē']]);
      input.write(['E2', 'reading', 'E2', ['e2', 'é']]);
      input.write(['A3', 'reading', 'A3', ['a3', 'ě']]);
      input.write(['E4', 'reading', 'E4', ['e4', 'è']]);
      input.write(['E5', 'reading', 'E5', ['e5', 'e']]);
      input.write(['I1', 'reading', 'I1', ['i1', 'ī']]);
      input.write(['I2', 'reading', 'I2', ['i2', 'í']]);
      input.write(['I3', 'reading', 'I3', ['i3', 'ǐ']]);
      input.write(['I4', 'reading', 'I4', ['i4', 'ì']]);
      input.write(['I5', 'reading', 'I5', ['i5', 'i']]);
      input.write(['O1', 'reading', 'O1', ['o1', 'ō']]);
      input.write(['O2', 'reading', 'O2', ['o2', 'ó']]);
      input.write(['O3', 'reading', 'O3', ['o3', 'ǒ']]);
      input.write(['O4', 'reading', 'O4', ['o4', 'ò']]);
      input.write(['O5', 'reading', 'O5', ['o5', 'o']]);
      input.write(['U1', 'reading', 'U1', ['u1', 'ū']]);
      input.write(['U2', 'reading', 'U2', ['u2', 'ú']]);
      input.write(['U3', 'reading', 'U3', ['u3', 'ǔ']]);
      input.write(['U4', 'reading', 'U4', ['u4', 'ù']]);
      input.write(['U5', 'reading', 'U5', ['u5', 'u']]);
      input.write(['Ü1', 'reading', 'Ü1', ['ü1', 'ǖ']]);
      input.write(['Ü2', 'reading', 'Ü2', ['ü2', 'ǘ']]);
      input.write(['Ü3', 'reading', 'Ü3', ['ü3', 'ǚ']]);
      input.write(['Ü4', 'reading', 'Ü4', ['ü4', 'ǜ']]);
      input.write(['Ü5', 'reading', 'Ü5', ['ü5', 'ü']]);
      return input.end();
    };
    matchers = [];
    show = function(handler) {
  ...
  if (module.parent == null) {
    include = ["dddddddddddddddddd", "eeeeeeeeeeeeeeeeee"];
    this._prune();
    this._main();
  }
