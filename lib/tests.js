...
(function() {
  var $, $async, CND, CODEC, D, HOLLERITH, after, alert, badge, clear_leveldb, db, debug, echo, get_new_db_name, help, include, info, join, later, leveldown, levelup, log, njs_path, read_all_keys, rpr, show_db_entries, show_keys_and_key_bfrs, step, suspend, test, urge, warn, whisper, ƒ,
    slice = [].slice,
    ...
    show = function(handler) {
      ...
      return input.pipe(D.$observe((function(_this) {
        ...
        return function() {
          var idx;
          idx = -1;
          return D.$observe(function(phrase, has_ended) {
            if (phrase != null) {
              idx += +1;
    ...
    show = function(handler) {
      ...
      return input.pipe(D.$observe((function(_this) {
        ...
        return function() {
          ...
          return D.$observe(function(record, has_ended) {
            var key, value;
            if (record != null) {
              idx += +1;
  ...
  this["(v4) read POS phrases (sbj is a list)"] = function(T, done) {
    ...
    show = function(handler) {
      var boxed_has_ended, input_boxed, query, unboxed_has_ended;
      ...
      return input_boxed.pipe(D.$observe((function(_this) {
        return function(phrase) {
  ...
  this["(v4) create_longphrasestream rejects illegal arguments"] = function(T, done) {
    var i, len, matcher, matchers, probe, probe_idx, probes;
    probes = [
      (function() {
        return HOLLERITH.create_longphrasestream(db, {
          hi: ['xxx']
        });
      }), (function() {
        return HOLLERITH.create_longphrasestream(db, {
  ...
  this["(v4) create_longphrasestream accepts legal arguments"] = function(T, done) {
    var i, len, probe, probe_idx, probes;
    probes = [
      (function() {
        return HOLLERITH.create_longphrasestream(db, {
          lo: ['xxx'],
  ...
  if (module.parent == null) {
    include = ["(v4) create_longphrasestream rejects illegal arguments", "(v4) create_longphrasestream accepts legal arguments"];
    this._prune();
    this._main();
  }
