...
(function() {
  ...
  if (module.parent == null) {
    include = ["(v4) values are `0x00` buffers", "(v4) store SPO, POS both as keys only", "(v4) store non-list subject as single-element list", "(v4) read POS phrases (sbj is a list)", "(v4) read POS phrases (sbj isn't a list)", "(v4) read POS phrases (sbj is a singleton list)", "(v4) create_longphrasestream rejects illegal arguments", "(v4) create_longphrasestream accepts legal arguments", "(v4) read normalized phrases"];
    this._prune();
    this._main();
  }
