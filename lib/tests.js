...
(function() {
  ...
  this["(v4) read POS phrases (sbj is a list)"] = function(T, done) {
    ...
    matchers = [['pos', 'usagecode', null, 'CJKTHM', ['glyph', '千']], ['pos', 'variant', null, '仟', ['glyph', '千']], ['pos', 'variant', null, '韆', ['glyph', '千']]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: ['pos'],
  ...
  if (module.parent == null) {
    include = ["(v4) store SPO, POS both as keys only", "(v4) store non-list subject as single-element list", "(v4) read POS phrases (sbj is a list)", "(v4) read POS phrases (sbj isn't a list)", "(v4) read POS phrases (sbj is a singleton list)", "(v4) read normalized phrases"];
    this._prune();
    this._main();
  }
