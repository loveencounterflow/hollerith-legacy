...
(function() {
    ...
    step((function(_this) {
      return function*(resume) {
        ...
        return input.pipe(D.$show()).pipe($(function(arg, send) {
          ...
          return debug('©GJfL6', HOLLERITH.CODEC.rpr_of_buffer(db, buffer));
  ...
  this["keep ordering and completeness in asynchronous streams"] = function(T, T_done) {
    return step((function(_this) {
      return function(resume) {
        var idx, input_A, input_B, write;
        idx = 0;
