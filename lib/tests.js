    ...
    $index = (function(_this) {
      return function(from_predicate, to_predicate, settings) {
        ...
        link = function(from_phrase, to_phrase) {
          var R, from_obj, from_prd, from_sbj, from_sub_obj, i, idx, j, len, len1, to_obj, to_prd, to_sbj, to_sub_obj;
          ...
          if ((CND.isa_list(from_sbj)) && from_sbj.length === 1) {
            from_sbj = from_sbj[0];
          }
          if ((CND.isa_list(to_sbj)) && to_sbj.length === 1) {
            to_sbj = to_sbj[0];
          }
