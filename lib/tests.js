(function() {
  ...
  this["read partial POS phrases"] = function(T, done) {
    ...
    idx = -1;
    count = 0;
    matchers = [['𧷟1', 'a', 42], ['𧷟1', 'ab', 42], ['𧷟1', 'guide', 'xxx'], ['𧷟1', 'guide/', 'yyy'], ['𧷟1', 'guide/foobar', 'zzz'], ['𧷟1', 'guide/lineup/length', 1], ['𧷟2', 'guide/lineup/length', 2], ['𧷟3', 'guide/lineup/length', 3], ['𧷟4', 'guide/lineup/length', 4], ['𧷟', 'guide/lineup/length', 5], ['𧷟6', 'guide/lineup/length', 6], ['𧷟', 'guide/uchr/has', '八', 0], ['𧷟', 'guide/uchr/has', '刀', 1], ['𧷟', 'guide/uchr/has', '宀', 2], ['𧷟', 'guide/uchr/has', '貝', 4], ['𧷟', 'guide/uchr/has', '', 3], ['𧷟1', 'z', 42]];
    return step((function(_this) {
      return function*(resume) {
        var input, prefix, settings;
        (yield _this._feed_test_data(db, probes_idx, resume));
