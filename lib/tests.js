...
(function() {
  ...
  this["_n-ary indexing"] = function(T, done) {
    var $index, show, write_data;
    $index = (function(_this) {
      return function(descriptions) {
        var arities, arity, link, new_index_phrase, phrase_counts, phrases, predicate, predicates;
        predicates = [];
        arities = [];
        phrases = [];
        phrase_counts = {};
        ...
        return $(function(phrase, send) {
          ...
          phrase_count += +1;
          if (phrase_count < predicates.length) {
            return null;
          }
          return urge('3040', phrases);
        });
      };
    })(this);
    write_data = function(handler) {
