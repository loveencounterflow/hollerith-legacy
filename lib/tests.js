...
(function() {
  ...
  if (module.parent == null) {
    include = ["(v4) values are `0x00` buffers", "(v4) store SPO, POS both as keys only", "(v4) store non-list subject as single-element list", "(v4) read POS phrases (sbj is a list)", "(v4) read POS phrases (sbj isn't a list)"];
    this._prune();
    this._main();
  }
