...
(function() {
  ...
  this["H2 codec `encode` throws on anything but a list"] = function(T, done) {
    ...
    T.throws(/^expected a list, got a (?:js)?undefined$/, (function() {
      return CODEC.encode();
    }));
    return done();
  };
  ...
  this["binary indexing"] = function(T, done) {
    var $index, matchers, show, write_data;
    $index = (function(_this) {
      return function(from_predicate, to_predicate, settings) {
        var from_cache, from_is_plural, link, new_index_phrase, to_cache, to_is_plural;
        if (settings == null) {
          settings = {};
        }
        from_is_plural = settings['from'] === 'plural';
        to_is_plural = settings['to'] === 'plural';
        from_cache = {};
        to_cache = {};
        ...
        link = function(from_phrase, to_phrase) {
          var R, fobj, fprd, fsbj, i, idx, j, k, l, len, len1, len2, len3, sub_fobj, sub_tobj, tobj, tprd, tsbj, tsbj_is_list;
        ...
        return $(function(phrase, send) {
          var from_phrase, i, index_phrase, j, len, len1, obj, prd, ref, ref1, sbj, sbj_txt, to_phrase;
          send(phrase);
          sbj = phrase[0], prd = phrase[1], obj = phrase[2];
          switch (prd) {
            case from_predicate:
              sbj_txt = JSON.stringify(sbj);
              if ((to_phrase = to_cache[sbj_txt]) != null) {
                delete to_cache[sbj_txt];
                ref = link(phrase, to_phrase);
                for (i = 0, len = ref.length; i < len; i++) {
                  index_phrase = ref[i];
                  send(index_phrase);
                }
            ...
            case to_predicate:
              sbj_txt = JSON.stringify(sbj);
              if ((from_phrase = from_cache[sbj_txt]) != null) {
                delete from_cache[sbj_txt];
                ref1 = link(from_phrase, phrase);
    ...
    write_data = function(handler) {
      var input;
      input = D.create_throughstream();
      input.pipe($index('reading', 'variant', {
        from: 'plural',
        to: 'plural'
      })).pipe($index('reading', 'similarity', {
        from: 'plural',
        to: 'plural'
      })).pipe($index('reading', 'strokeorder', {
        from: 'plural',
        to: 'singular'
      })).pipe($index('strokeorder', 'reading', {
        from: 'singular',
        to: 'plural'
      })).pipe($index('strokeorder', 'usagecode', {
        from: 'singular',
        to: 'singular'
      })).pipe(HOLLERITH.$write(db)).pipe(D.$on_end(function() {
        return handler();
      }));
    ...
    matchers = [["pos", "reading", "bar", ["千"], 2], ["pos", "reading", "bar", ["千", "similarity", 4, "于"]], ["pos", "reading", "bar", ["千", "similarity", 5, "干"]], ["pos", "reading", "bar", ["千", "strokeorder", 2, "312"]], ["pos", "reading", "bar", ["千", "variant", 4, "仟"]], ["pos", "reading", "bar", ["千", "variant", 5, "韆"]], ["pos", "reading", "foo", ["千"], 1], ["pos", "reading", "foo", ["千", "similarity", 2, "于"]], ["pos", "reading", "foo", ["千", "similarity", 3, "干"]], ["pos", "reading", "foo", ["千", "strokeorder", 1, "312"]], ["pos", "reading", "foo", ["千", "variant", 2, "仟"]], ["pos", "reading", "foo", ["千", "variant", 3, "韆"]], ["pos", "reading", "qian", ["仟"], 0], ["pos", "reading", "qian", ["仟", "strokeorder", 0, "32312"]], ["pos", "reading", "qian", ["千"], 0], ["pos", "reading", "qian", ["千", "similarity", 0, "于"]], ["pos", "reading", "qian", ["千", "similarity", 1, "干"]], ["pos", "reading", "qian", ["千", "strokeorder", 0, "312"]], ["pos", "reading", "qian", ["千", "variant", 0, "仟"]], ["pos", "reading", "qian", ["千", "variant", 1, "韆"]], ["pos", "reading", "qian", ["韆"], 0], ["pos", "reading", "qian", ["韆", "strokeorder", 0, "122125112125221134515454"]], ["pos", "similarity", "于", ["千"], 0], ["pos", "similarity", "干", ["千"], 1], ["pos", "strokeorder", "122125112125221134515454", ["韆"]], ["pos", "strokeorder", "122125112125221134515454", ["韆", "reading", 0, "qian"]], ["pos", "strokeorder", "122125112125221134515454", ["韆", "usagecode", 0, "KTHm"]], ["pos", "strokeorder", "312", ["千"]], ["pos", "strokeorder", "312", ["千", "reading", 0, "qian"]], ["pos", "strokeorder", "312", ["千", "reading", 1, "foo"]], ["pos", "strokeorder", "312", ["千", "reading", 2, "bar"]], ["pos", "strokeorder", "312", ["千", "usagecode", 0, "CJKTHM"]], ["pos", "strokeorder", "32312", ["仟"]], ["pos", "strokeorder", "32312", ["仟", "reading", 0, "qian"]], ["pos", "strokeorder", "32312", ["仟", "usagecode", 0, "CJKTHm"]], ["pos", "usagecode", "CJKTHM", ["千"]], ["pos", "usagecode", "CJKTHm", ["仟"]], ["pos", "usagecode", "KTHm", ["韆"]], ["pos", "variant", "仟", ["千"], 0], ["pos", "variant", "韆", ["千"], 1]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: ['pos'],
  ...
  this["n-ary indexing (1)"] = function(T, done) {
    var $index, matchers, show, write_data;
    $index = (function(_this) {
    ...
    matchers = [["pos", "reading", "bar", ["千"], 2], ["pos", "reading", "bar", ["千", "similarity", 4, "于"]], ["pos", "reading", "bar", ["千", "similarity", 5, "干"]], ["pos", "reading", "bar", ["千", "strokeorder", 2, "312"]], ["pos", "reading", "bar", ["千", "variant", 4, "仟"]], ["pos", "reading", "bar", ["千", "variant", 5, "韆"]], ["pos", "reading", "foo", ["千"], 1], ["pos", "reading", "foo", ["千", "similarity", 2, "于"]], ["pos", "reading", "foo", ["千", "similarity", 3, "干"]], ["pos", "reading", "foo", ["千", "strokeorder", 1, "312"]], ["pos", "reading", "foo", ["千", "variant", 2, "仟"]], ["pos", "reading", "foo", ["千", "variant", 3, "韆"]], ["pos", "reading", "qian", ["仟"], 0], ["pos", "reading", "qian", ["仟", "strokeorder", 0, "32312"]], ["pos", "reading", "qian", ["千"], 0], ["pos", "reading", "qian", ["千", "similarity", 0, "于"]], ["pos", "reading", "qian", ["千", "similarity", 1, "干"]], ["pos", "reading", "qian", ["千", "strokeorder", 0, "312"]], ["pos", "reading", "qian", ["千", "variant", 0, "仟"]], ["pos", "reading", "qian", ["千", "variant", 1, "韆"]], ["pos", "reading", "qian", ["韆"], 0], ["pos", "reading", "qian", ["韆", "strokeorder", 0, "122125112125221134515454"]], ["pos", "similarity", "于", ["千"], 0], ["pos", "similarity", "干", ["千"], 1], ["pos", "strokeorder", "122125112125221134515454", ["韆"]], ["pos", "strokeorder", "122125112125221134515454", ["韆", "reading", 0, "qian"]], ["pos", "strokeorder", "312", ["千"]], ["pos", "strokeorder", "312", ["千", "reading", 0, "qian"]], ["pos", "strokeorder", "312", ["千", "reading", 1, "foo"]], ["pos", "strokeorder", "312", ["千", "reading", 2, "bar"]], ["pos", "strokeorder", "312", ["千", "similarity", 0, "于"]], ["pos", "strokeorder", "312", ["千", "similarity", 1, "干"]], ["pos", "strokeorder", "312", ["千", "variant", 0, "仟"]], ["pos", "strokeorder", "312", ["千", "variant", 1, "韆"]], ["pos", "strokeorder", "32312", ["仟"]], ["pos", "strokeorder", "32312", ["仟", "reading", 0, "qian"]], ["pos", "usagecode", "CJKTHM", ["千"]], ["pos", "usagecode", "CJKTHm", ["仟"]], ["pos", "usagecode", "KTHm", ["韆"]], ["pos", "variant", "仟", ["千"], 0], ["pos", "variant", "韆", ["千"], 1]];
    show = function(handler) {
      var input, query;
      query = {
        prefix: ['pos'],
  ...
  this["n-ary indexing (2)"] = function(T, done) {
    var matchers, show, write_data;
    write_data = function(handler) {
      var input;
      input = D.create_throughstream();
      input.pipe(HOLLERITH.$index({
        'reading': 'plural',
        'similarity': 'plural'
      })).pipe(HOLLERITH.$index({
        'reading': 'plural',
        'variant': 'plural'
      })).pipe(HOLLERITH.$index({
        'reading': 'plural',
  ...
  if (module.parent == null) {
    include = ['n-ary indexing (1)', 'n-ary indexing (2)'];
    this._prune();
    this._main();
  }
