...
(function() {
  ...
  this["(v4) secondary indexing, API"] = function(T, done) {
    ...
    write_data = function(handler) {
      ...
      IDX = Symbol["for"]('index');
      input = D.new_stream();
      input.pipe(HOLLERITH.$index_v4(db, 'reading', 'variant')).pipe(HOLLERITH.$write(db, {
        unique: false
      })).pipe(D.$on_finish(handler));
  ...
  this["(v4) read POS phrases (sbj is a list)"] = function(T, done) {
    ...
    show = function(handler) {
      ...
      return input_boxed.pipe($((function(_this) {
        return function(phrase) {
  ...
  if (module.parent == null) {
    include = ["(v4) values are `0x00` buffers", "(v4) store SPO, POS both as keys only", "(v4) store non-list subject as single-element list", "(v4) read POS phrases (sbj is a list)", "(v4) read POS phrases (sbj isn't a list)", "(v4) create_longphrasestream rejects illegal arguments", "(v4) create_longphrasestream accepts legal arguments", "(v4) read normalized phrases", "(v4) read POS phrases (sbj is a singleton list)"];
    this._prune();
    this._main();
  }
