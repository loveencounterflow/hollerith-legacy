...
(function() {
  ...
  this["use non-string subjects in phrases"] = function(T, done) {
    var show, write_data;
    write_data = function(handler) {
      ...
      input.write([['ref', '千', 0], 'guide/kwic/v3/sortcode', [[['0774f---', '0000f---', null], ['亻', [], ['一']]], [['0000f---', null, '0774f---'], ['一', ['亻'], []]]]]);
      input.write([['ref', '千', 1], 'guide/kwic/v3/sortcode', [[['0645f---', '0104f---', null], ['丿', [], ['十']]], [['0104f---', null, '0645f---'], ['十', ['丿'], []]]]]);
      return input.end();
    };
  ...
  if (module.parent == null) {
    include = ["use non-string subjects in phrases"];
    this._prune();
    this._main();
  }
