(function() {
  var $, Bloom, CND, CODEC, D, DUMP, _codec_decode, _codec_encode, _new_level_db, badge, debug, echo, help, leveldown, log, repeat_immediately, rpr, step, suspend, urge, warn, whisper,
  ...
  this._get_bloom_methods = function(db) {
    var $ensure_unique_spo, $load_bloom, $save_bloom, BLOEM, BSON, bloem_settings, bloom_error_rate, db_size, njs_fs, ref, ref1, ref2, show_bloom_info;
