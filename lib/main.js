...
(function() {
  var $, $async, $on_finish, CND, CODEC, D, DUMP, _codec_decode, _codec_encode, _codec_encode_plus_tm_hi, _new_level_db, badge, debug, echo, help, info, leveldown, log, rpr, step, suspend, urge, warn, whisper, ƒ,
    slice = [].slice,
  ...
  this._$add_secondary_index = (function(_this) {
    return function(db) {
      ...
      return $(function(phrase, send, end) {
        var _, i, index_settings, j, k, l, lead_idx, lead_obj, lead_phrase, lead_phrases, lead_phrases_by_sbj_txts, lead_prd, lead_sbj, len, len1, len2, obj, prd, predicates, sbj, sbj_txt, tail_idx, tail_obj, tail_phrase, tail_phrases, tail_phrases_by_sbj_txts, tail_prd, tail_sbj, target;
        sbj_txt = null;
        if (phrase != null) {
            ...
            for (sbj_txt in lead_phrases_by_sbj_txts) {
              ...
              for (k = 0, len1 = lead_phrases.length; k < len1; k++) {
                ...
                for (l = 0, len2 = tail_phrases.length; l < len2; l++) {
                  ...
                  _ = tail_phrase[0], tail_prd = tail_phrase[1], tail_idx = tail_phrase[2], tail_obj = tail_phrase[3], tail_sbj = tail_phrase[4];
