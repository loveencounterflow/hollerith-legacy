(function() {
  ...
  this._get_bloom_methods = function(db) {
    var $ensure_unique_spo, $load_bloom, $save_bloom, BLOEM, BSON, bloem_settings, bloom_error_rate, db_size, entry_count, miss_count, njs_fs, ref, show_bloom_info;
    db_size = (ref = db['size']) != null ? ref : 1e5;
      ...
      return function() {
        ...
        return D.$map(function(data, handler) {
          ...
          return _this._get_meta(db, 'bloom', null, function(error, bloom_bfr) {
            var bitfield, bloom, bloom_data, filter, i, len, ref1;
            if (error != null) {
              return handler(error);
            }
            if (bloom_bfr === null) {
