...
(function() {
  ...
  this.$write = function(db, settings) {
    var $add_primary_index, $add_secondary_index, $encode, $write, R, batch_size, batch_written, ensure_unique, is_integer, loner_predicates, pipeline, ref, ref1, ref2, ref3, solid_predicates, substrate;
    if (settings == null) {
      settings = {};
    }
  ...
  this._add_secondary_index = (function(_this) {
    return function(description, handler) {
      ...
      input = _this.create_phrasestream(db, query);
