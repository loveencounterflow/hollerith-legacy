...
(function() {
  ...
  this.$write = function(db, settings) {
    var $add_primary_index, $add_secondary_index, $encode, $write, batch_size, batch_written, ensure_unique, is_integer, loner_predicates, pipeline, ref, ref1, ref2, ref3, solid_predicates, substrate;
    if (settings == null) {
      settings = {};
    }
    ...
    $add_secondary_index = (function(_this) {
      return function() {
        ...
        return $async(function(phrase, send, end) {
          var _, entry, i, len, predicates;
          debug('7765-1', phrase);
          if (phrase != null) {
            if (phrase[0] !== Symbol["for"]('make-secondary-index')) {
              return send.done(phrase);
            }
            _ = phrase[0], db = phrase[1], predicates = phrase[2];
            cache.push({
              db: db,
          ...
          if (end != null) {
            for (i = 0, len = cache.length; i < len; i++) {
              entry = cache[i];
              _this._add_secondary_index.apply(_this, entry);
            }
            end();
            return send.done();
          }
    ...
    $write = (function(_this) {
      return function() {
        return $async(function(batch, send) {
  ...
  this.$index_v4 = (function(_this) {
    return function() {
      ...
      return D.$on_start(function(send) {
        return send([Symbol["for"]('make-secondary-index'), db, predicates]);
      });
    };
  })(this);

  this._add_secondary_index = (function(_this) {
    return function(description, handler) {
      var input, query;
      ...
      return input.pipe($(function(phrase) {
        if (phrase) {
          return whisper('_add_secondary_index', phrase);
        }
      }));
    };
  })(this);
