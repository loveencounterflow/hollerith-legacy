(function() {
  ...
  this.$write = function(db, settings) {
    ...
    var $as_batch_entry, $encode, $ensure_unique_sp, $index, $load_bloom, $save_bloom, $write, R, batch_size, batch_written, ensure_unique, pipeline, ref, ref1, ref2, ref3, solid_predicates, substrate;
    if (settings == null) {
      settings = {};
    }
    ...
    if (ensure_unique) {
      ref3 = this._get_bloom_methods(db), batch_written = ref3.batch_written, $ensure_unique_sp = ref3.$ensure_unique_sp, $load_bloom = ref3.$load_bloom, $save_bloom = ref3.$save_bloom;
    } else {
    ...
    $ensure_unique_sp = (function(_this) {
      return function() {
        return $async(function(spo, done) {
          var XXX, _, bloom, bloom_has_key, key, key_bfr, key_txt, prd, sbj, seen_has_key;
          sbj = spo[0], prd = spo[1], _ = spo[2];
          XXX = prd === 'guide/kwic/v3/sortcode';
          key = [sbj, prd];
