...
(function() {
  ...
  this._new_db = function(route, settings) {
    ...
    var R, create_if_missing, decoder, encoder, keys, level_settings, ref, ref1, ref2, substrate;
    if (!((settings == null) || !CND.is_subset((keys = Object.keys(settings)), this._new_db.keys))) {
