(function() {
  var $, $async, CND, D, HOLLERITH, KWIC, after, alert, badge, debug, echo, eventually, every, help, immediately, info, join, log, njs_path, options, repeat_immediately, rpr, step, suspend, urge, warn, whisper, ƒ,
