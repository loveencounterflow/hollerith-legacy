  ...
  this.copy_jizura_db = function() {
    ...
    return step((function(_this) {
      return function*(resume) {
        ...
        })).pipe(DEMO._$split_so_bkey()).pipe(_this.$keep_small_sample()).pipe(_this.$throw_out_pods()).pipe(_this.$cast_types(ds_options)).pipe(_this.$collect_lists()).pipe(D.$count(function(count) {
