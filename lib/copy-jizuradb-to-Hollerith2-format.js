(function() {
  ...
  this.$add_kwic_v2 = function() {
    ...
    var last_glyph, lineup_v1;
    last_glyph = null;
    lineup_v1 = null;
    return $((function(_this) {
      return function(arg, send) {
        var _, glyph, i, idx, j, k, l, len, len1, len2, len3, len4, lineup, lineup_v2, m, obj, position, prd, ref, ref1, ref2, sbj, sortcode, sortcode_v1, sortcodes_v1, sortcodes_v2, sortrow_v1, sortrow_v2, x;
        sbj = arg[0], prd = arg[1], obj = arg[2];
        ...
        switch (prd.replace(/^guide\/kwic\/v1\//, '')) {
          ...
          case 'sortcode':
            ...
            lineup_v2 = lineup_v1;
            for (idx = l = 0, len3 = lineup_v1.length; l < len3; idx = ++l) {
              lineup = lineup_v1[idx];
              sortcodes_v1[idx] += ";" + lineup;
            }
            for (idx = m = 0, len4 = lineup_v2.length; m < len4; idx = ++m) {
              lineup = lineup_v2[idx];
  ...
  this.copy_jizura_db = function() {
    ...
    return step((function(_this) {
      return function*(resume) {
        ...
        })).pipe(_this.v1_$split_so_bkey()).pipe(_this.$keep_small_sample()).pipe(_this.$throw_out_pods()).pipe(_this.$cast_types(ds_options)).pipe(_this.$collect_lists()).pipe(_this.$compact_lists()).pipe(_this.$add_version_to_kwic_v1()).pipe(_this.$add_kwic_v2()).pipe(D.$show()).pipe(D.$count(function(count) {
