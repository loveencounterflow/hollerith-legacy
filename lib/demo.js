(function() {
  ...
  this.show_kwic_v2_sample = function(db) {
    return step((function(_this) {
      return function*(resume) {
        var $exclude_gaiji, $extract_lineup, $include_sample, $reorder_phrase, $transform, db_route, include, input_v1, input_v2, prefix_v1, prefix_v2, ranks, sample;
        db_route = join(__dirname, '../../jizura-datasources/data/leveldb-v2');
        if (db == null) {
          db = HOLLERITH.new_db(db_route, {
            create: false
        ...
        input_v1.pipe(D.$lockstep(input_v2)).pipe((function() {
          var count;
          count = 0;
          return $(function(arg, send) {
  ...
  this.show_encoding_sample = function() {
    ...
    b = new Buffer('一x丁x丂');
    return help(HOLLERITH.CODEC.rpr_of_buffer(null, HOLLERITH.CODEC.encode([true, -1 / 7])));
  };
