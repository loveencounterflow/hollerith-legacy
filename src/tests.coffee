...
@[ "XXX" ] = ( T, done ) ->
  ...
  n       = 10
  # #---------------------------------------------------------------------------------------------------------
  # input_A.on 'data', ( data ) =>
  #   help "input_A.on 'data', #{rpr data}"
  # #---------------------------------------------------------------------------------------------------------
  # input_A.on 'end', =>
  #   help "input_A/end"
  #---------------------------------------------------------------------------------------------------------
  input_B = input_A
    # #.....................................................................................................
    # .pipe $ ( data, send ) =>
    #   whisper "cp1: #{rpr data}"
    #   immediately => send data
    #.....................................................................................................
    .pipe D.$map ( data, handler ) =>
      [ key, value, ] = data
      db.get key, ( error ) =>
        if error?
          ...
          handler new Error "key already in DB: #{rpr key}"
    #.....................................................................................................
    .pipe D.$batch 5
    #.....................................................................................................
    .pipe do ( db ) =>
      return $ ( batch, send ) =>
        # whisper "cp4: #{rpr batch}"
